			...
			<div style="padding:30px; padding-top:5px;">
				<table width="100%">
					<tr>
						...
						<td align="right">
							<button type="button" class="btn btn-secondary" style="background-color:lightpnk; border:lightpnk;"><a href="allApproved.adm">승인/거절 건 조회</a></button>
						</td>
					</tr>
				</table>
			</div>
				...
				<tbody>
					<c:forEach var="p" items="${list}">
						<tr align="center">
							...
							<td>${p.seatList}</td>
							<td>${p.seatPrice}&nbsp;원</td>
							<td><b><a href='doRefund.prce?purchaseNo=${p.purchaseNo}'>승인</a>&nbsp;/&nbsp;<a href='noRefund.prce?purchaseNo=${p.purchaseNo}'>거절</a></b><td>
						</tr>
					</c:forEach>
				</tbody>
				<tfoot>
